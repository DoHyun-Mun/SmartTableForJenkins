		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Table Sample",
									"targetURL": "#comsapdemosmarttableforjenkins-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdemosmarttableforjenkins-display": {
								"semanticObject": "comsapdemosmarttableforjenkins",
								"action": "display",
								"description": "A Smart Table Sample Fiori Application",
								"title": "Smart Table Sample",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.demo.smarttableforjenkins",
									"url": sap.ui.require.toUrl("com/sap/demo/smarttableforjenkins")
								}
							}
						}
					}
